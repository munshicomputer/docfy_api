<?php
  ...
  public function update() {
        // Create query
        $query = 'UPDATE ' . $this->table . ' SET user_role_id = :user_role_id, full_name = :full_name, email_address = :email_address, password = :password, mobile = :mobile, photo = :photo, update_date = :update_date WHERE id = :id';
